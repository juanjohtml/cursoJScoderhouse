let salida=prompt("presione enter para continuar o escriba (salir) para terminar ")  
while(salida!="salir"){
    let nombre = prompt(`ingresa tu nombre`);
    let monto = parseInt(prompt(`ingresa el monto al cual quieres acceder`));
    let cuotas = parseInt(prompt(`ahora en cuantas cuotas lo quieres abonar (3,6,12,18,24)`));
    let resultado = 0;
    ...
    salida=prompt(`presione enter para continuar o escriba (salir) para terminar`)
}